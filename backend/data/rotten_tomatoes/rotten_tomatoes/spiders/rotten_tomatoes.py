...
class RottenTomatoesSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        release_date = response.xpath('//section[@class="media-info"]/div[@class="content-wrap"]/dl/div[@class="category-wrap"]/dt[contains(.,"Release Date (Theaters)")]/following-sibling::dd/rt-text/text()').get()
        director = response.xpath('//section[@class="media-info"]/div[@class="content-wrap"]/dl/div[@class="category-wrap"]/dt[contains(.,"Director")]/following-sibling::dd/rt-link/text()').getall()
